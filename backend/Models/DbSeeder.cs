        ...
        public static class DbSeeder
        {
            public static void Seed(ModelBuilder modelBuilder)
            {
                ...
                modelBuilder.Entity<Recipe>().HasData(
                    new Recipe { Id = 1, Name = "Pancakes", CategoryId = 1 },
                    new Recipe { Id = 2, Name = "Grilled Cheese Sandwich", CategoryId = 2 },
                    new Recipe { Id = 3, Name = "Spaghetti Carbonara", CategoryId = 3 },
                    new Recipe { Id = 4, Name = "Caesar Salad", CategoryId = 2 },
                    new Recipe { Id = 5, Name = "Omelette", CategoryId = 1 },
                    new Recipe { Id = 6, Name = "French Toast", CategoryId = 1 },
                    new Recipe { Id = 7, Name = "Chocolate Cake", CategoryId = 4 },
                    new Recipe { Id = 8, Name = "Apple Pie", CategoryId = 4 },
                    new Recipe { Id = 9, Name = "Tacos", CategoryId = 3 },
                    new Recipe { Id = 10, Name = "Chicken Curry", CategoryId = 3 },
                    new Recipe { Id = 11, Name = "Beef Stew", CategoryId = 3 },
                    new Recipe { Id = 12, Name = "Fish and Chips", CategoryId = 2 },
                    new Recipe { Id = 13, Name = "Mushroom Soup", CategoryId = 2 },
                    new Recipe { Id = 14, Name = "Roast Chicken", CategoryId = 3 },
                    new Recipe { Id = 15, Name = "Waffles", CategoryId = 1 },
                    new Recipe { Id = 16, Name = "Pasta Salad", CategoryId = 2 },
                    new Recipe { Id = 17, Name = "BBQ Ribs", CategoryId = 3 },
                    new Recipe { Id = 18, Name = "Steak", CategoryId = 3 },
                    new Recipe { Id = 19, Name = "Fruit Salad", CategoryId = 4 },
                    new Recipe { Id = 20, Name = "Banana Bread", CategoryId = 4 }
                );
